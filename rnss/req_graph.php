...
<script type="text/javascript">
        ...
        function load_datewise_data(e)
        {
            ...
            var temp_title = "Date wise Request";
            $.ajax({
                url:"req_datewise.php?request_date",
                method:"POST",
                data:{
    ...
    <script>
    	$(document).ready(function() {
            ...
            function drawChart2(pur_data)
            {
                    ...
                    var chart1 = new google.visualization.ColumnChart(document.getElementById('chart_area2'));
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <div>
        ...
        <div id="chart_area2" style="width: 900px; height: 620px;"></div>
    <br/>    
    </div> 
</body>
</html>
