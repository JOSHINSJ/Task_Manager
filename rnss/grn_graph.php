    ...
    <script>
        $(document).ready(function() {
            ...
            function drawChart2(pur_data)
            {
                    ...
                    var chart1 = new google.visualization.LineChart(document.getElementById('chart_area1'));
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <div>
        ...
        <div id="chart_area1" style="width: 900px; height: 620px;"></div>
    <br/>    
    </div> 
</body>
</html>
